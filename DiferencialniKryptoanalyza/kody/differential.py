...
def main():
    # %%%%%% DEFAULT ARGS %%%%%% #
    enc_key = 0x3b6c #key for encryption - normally, this is unknown, and not used later
    size = 10000 #number of plaintext block generated
    deltaP = 0b0000000011110000 #what bits differ at P
    expected_deltaU4 = 0b0000010101010000 #what bits must differ at U4
    key_mask = 0b0110 #Sbox mask
    prob = 81/4096
